 ...
 * that can't cause harm on a Flagsmith outage:
 ...
 *    on ML or in Miyagi) is worse than the feature being off, so a Flagsmith
 *    outage must HALT sync, not run it uncontrolled. Enabling is the deliberate
